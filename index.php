...
define('api_key',   '9yg8gjumbww5j7yrfxk83ypz'); // enter your MYOB Developer Key
define('api_secret',  '6b5EM7w8yuxrGNGZVJ4DDCbP'); // enter your MYOB Developer Secret
define('redirect_url',  'http://myob-oauth.lionsliar.net.au'); // enter the Redirect URL
...
define('base_url',    'http://myob-oauth.lionsliar.net.au/');
